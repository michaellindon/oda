...
col_normal_em <- function(ryo, rxo, rxa, rd, rlam, rpriorprob, rselection) {
    .Call('oda_col_normal_em', PACKAGE = 'oda', ryo, rxo, rxa, rd, rlam, rpriorprob, rselection)
}
...
col_mixture_gibbs <- function(ryo, rxo, rxa, rpriorprob, rburnin, rniter, ralpha) {
    .Call('oda_col_mixture_gibbs', PACKAGE = 'oda', ryo, rxo, rxa, rpriorprob, rburnin, rniter, ralpha)
}

lasso_em <- function(ryo, rxo, rxa, rd, rlasso) {
    .Call('oda_lasso_em', PACKAGE = 'oda', ryo, rxo, rxa, rd, rlasso)
}
...
oda_gdp_em <- function(ryo, rxo, rxa, rd, rpriorprob, ralpha, reta) {
    .Call('oda_oda_gdp_em', PACKAGE = 'oda', ryo, rxo, rxa, rd, rpriorprob, ralpha, reta)
}

or_gdp_em <- function(ryo, rxo, ralpha, reta) {
    .Call('oda_or_gdp_em', PACKAGE = 'oda', ryo, rxo, ralpha, reta)
}

or_lasso_em <- function(ryo, rxo, rlasso) {
    .Call('oda_or_lasso_em', PACKAGE = 'oda', ryo, rxo, rlasso)
}

probit_normal_em <- function(rbit, rxo, rxa, rd, rlam, rpriorprob) {
    .Call('oda_probit_normal_em', PACKAGE = 'oda', rbit, rxo, rxa, rd, rlam, rpriorprob)
}
...
t_em <- function(ryo, rxo, rxa, rd, rpriorprob, ralpha) {
    .Call('oda_t_em', PACKAGE = 'oda', ryo, rxo, rxa, rd, rpriorprob, ralpha)
}

mixture_gibbs <- function(ryo, rxo, rxa, rd, rpriorprob, rburnin, rniter, ralpha) {
    .Call('oda_mixture_gibbs', PACKAGE = 'oda', ryo, rxo, rxa, rd, rpriorprob, rburnin, rniter, ralpha)
}
